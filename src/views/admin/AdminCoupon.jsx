    ...
    <div className="min-h-screen bg-[#FAF9F6] px-6 py-12 font-sans text-[#111111]">
      ...
      <div className="max-w-7xl mx-auto mb-20">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 border-b border-[#D1C7B7] pb-10 relative">
          ...
          >
            ...
            <span className="relative text-[0.75rem] uppercase tracking-[0.4em] font-bold text-[#111111] group-hover:text-[#FAF9F6] transition-colors duration-700">
              簽署新優惠 · ISSUE
            </span>
          </button>
        </div>
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-24">
        <div className="p-8 border-l border-[#D1C7B7]/30 hover:border-[#111111] transition-colors duration-500">
           <span className="text-[0.75rem] uppercase tracking-widest font-bold opacity-30 block mb-2">現行優惠總數</span>
        ...
        <div className="p-8 border-l border-[#D1C7B7]/30 hover:border-[#3A4D39] transition-colors duration-500">
           <span className="text-[0.75rem] uppercase tracking-widest font-bold opacity-30 block mb-2">折扣效應評核</span>
                ...
                coupons.map((coupon) => (
                  <tr key={coupon.id} className="hover:bg-[#111111]/[0.02] transition-colors duration-500 group">
                    <td className="px-4 py-10">
                      ...
                      <div className="text-[0.75rem] opacity-20 font-mono tracking-tighter mt-1">REF: {coupon.id.slice(-10)}</div>
                    </td>
                    ...
                    <td className="px-4 py-10">
                       ...
                       <span className="text-[0.75rem] uppercase tracking-widest font-black ml-2 opacity-20">Percent Off</span>
                    </td>
                    <td className="px-4 py-10 hidden md:table-cell">
                    ...
                    <td className="px-4 py-10 text-center">
                       <div className="flex flex-col items-center gap-1">
                          ...
                          <span className={`text-[0.75rem] uppercase tracking-[0.2em] font-bold ${coupon.is_enabled ? 'text-[#3A4D39]' : 'opacity-10'}`}>
                    ...
                    <td className="px-4 py-10 text-right">
                      <div className="inline-flex gap-8">
                        <button
                          className="text-[0.75rem] uppercase tracking-[0.3em] font-bold text-[#111111]/40 hover:text-[#111111] transition-colors"
                          onClick={() => openModal('edit', coupon)}
                        >
                          修訂
                        </button>
                        <button
                          className="text-[0.75rem] uppercase tracking-[0.3em] font-bold text-[#984443]/40 hover:text-[#984443] transition-colors"
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 md:p-12">
           ...
           <div className="relative w-full max-w-4xl bg-[#FAF9F6] shadow-2xl overflow-hidden flex flex-col md:flex-row h-full max-h-[85vh] animate-in fade-in zoom-in duration-700">
              ...
              <div className="md:w-2/5 bg-[#111111] p-12 flex flex-col justify-between text-white border-r border-[#984443]/20">
                <div>
                   <div className="text-[0.75rem] uppercase tracking-[0.6em] text-[#984443] font-black mb-8">Accession Record</div>
              ...
              <div className="flex-grow p-12 overflow-y-auto custom-scrollbar bg-white">
                <div className="max-w-md mx-auto space-y-12">
                   ...
                   <section className="space-y-4">
                      <label className="text-[0.75rem] uppercase tracking-[0.4em] font-black text-[#111111]/30 block px-1">活動名錄 / NOMENCLATURE</label>
                      <input
                        type="text"
                   ...
                   {/* Code Input */}
                   <section className="space-y-4">
                      <label className="text-[0.75rem] uppercase tracking-[0.4em] font-black text-[#111111]/30 block px-1">優惠代碼 / UNIQUE CIPHER</label>
                      <input
                        type="text"
                   ...
                   <div className="grid grid-cols-2 gap-12">
                      {/* Date Input */}
                      <section className="space-y-4">
                         <label className="text-[0.75rem] uppercase tracking-[0.4em] font-black text-[#111111]/30 block px-1">有效截期 / EXPIRY</label>
                         <input
                           type="date"
                      ...
                      {/* Percent Input */}
                      <section className="space-y-4">
                         <label className="text-[0.75rem] uppercase tracking-[0.4em] font-black text-[#111111]/30 block px-1">折扣權重 / VALUE</label>
                   ...
                   <section className="pt-8 border-t border-[#D1C7B7]/10">
                      <label className="flex items-center gap-6 cursor-pointer group">
                        ...
                        <div className="flex flex-col">
                           ...
                           <span className="text-[0.75rem] opacity-20 italic">將此優惠文草正式發佈於大眾檢閱與使用</span>
                        </div>
                      </label>
                   </section>
